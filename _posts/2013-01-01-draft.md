...
[^3]: second_way does d divisions by 10 for a d-digit number, str does $$frac{d}{9}$$ divisions by $$10^9$$ (32-bits) or $$d/18$$ divisions by $$10^{18}$$ (64-bits) and then d divisions by 10.
