...
The next time I need to sum the digits of an integer[^5] I will use the first way. Even though second_way_optimized was faster, I don't think the added complexity is worth it.
